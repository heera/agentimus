...
<template>
  <form class="ar-form" @submit.prevent="$emit('save-profile')">
    ...
    <div v-show="group === 'discovery'" class="ar-group" data-group="discovery">
      ...
      <!-- Share your score — the opt-in PUBLIC scorecard ------------------ -->
      <section id="ar-sec-scorecard" class="ar-card">
        ...
        <p class="ar-card__lead">
          ...
          can embed anywhere, and a preview image so the link unfurls with your score when
          it's shared. Everything is generated by your own site — nothing is sent
        ...
        <div :inert="!settings.share_scorecard" class="ar-webmcp-tools">
          ...
          <p class="ar-field__hint">
            The page and preview card use your theme's accent color automatically; the badge
        ...
        <div v-show="settings.share_scorecard" class="ar-mcp-connect">
          ...
          <p><img :src="badgeSrc" alt="AI readiness badge preview" height="28" /></p>
          <p class="ar-field__hint">
          ...
          <pre class="ar-mcp-snippet__code">{{ badgeSnippet }}</pre>
          <p>
            <button type="button" class="button button-small" @click="copyBadgeSnippet">
              {{ badgeCopied ? 'Copied ✓' : 'Copy the badge code' }}
            </button>
          </p>
