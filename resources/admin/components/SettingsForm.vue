  ...
  computed: {
    ...
    features() {
      ...
      return [
        ...
        { key: 'enable_page_checks', label: 'Readability tips', hint: 'Adds a “Readability” panel in the post editor with per-page tips (headings, summary, thin content, image alt). Most of them serve search engines and screen readers as much as AI assistants. Editor-only — nothing is shown to visitors.' },
