      ...
      featureGroups: [
        ...
        },
        {
          ...
          items: [
            ...
            { name: 'Fill The Gaps', where: 'its own screen, under More', desc: 'The whole site at once: finds every published page missing its AI description or topics — and every image your pages use that has no alt text — then drafts the missing pieces in capped batches (25 at a time, resumable). Every draft lands on a review list first: you read it, then click Apply or Dismiss — per item, or ticked in bulk. Nothing is saved unapproved, a field you filled yourself is never touched, and the screen states the cost plainly before it starts — one AI request per item, against the provider you connected. Alt text is drafted by actually showing your image to a vision-capable model.', tag: 'Opt-in' },
