  ...
  data() {
    return {
      ...
      featureGroups: [
        ...
        },
        {
          ...
          items: [
            ...
            { name: 'Traffic from AI', where: 'More → Readers', desc: 'Real visitors who arrived from ChatGPT, Perplexity, Gemini, Claude, Copilot, Grok, DeepSeek and more — day by day, by source and landing page. Some AI visits can’t be detected, so read it as a floor. The dashboard card drills in everywhere: its day bars open the per-day detail, and each source or landing page opens the full report pre-filtered to it.', tag: 'On' },
      ...
      faqs: [
        ...
        { q: 'Where do I see what AI is doing on my site?', a: 'Three places, all on your own server. The Dashboard summarises both directions — which AI crawlers fetched your files, and how many readers AI sent you. More → Readers is the full report on those readers: day by day, by assistant and landing page. More → Request Log is the full report on the crawlers: one row per request, filterable by client, endpoint, network and date.' },
