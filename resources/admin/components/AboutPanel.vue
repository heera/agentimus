      ...
      featureGroups: [
        ...
        },
        {
          ...
          items: [
            ...
            { name: 'Verified bots', where: 'Settings → AI Access', desc: 'Optionally confirm a visitor claiming a known crawler really is that crawler, using what its operator publishes: forward-confirmed reverse DNS (Googlebot, Bingbot, Applebot, Yandex) and published IP-range files (DuckDuckBot, GPTBot, OAI-SearchBot, PerplexityBot — refreshed once a day in the background, never while serving a visitor). The list is yours to edit: switch any crawler off, or add a new operator yourself the day it starts publishing verification data.', tag: 'Opt-in' },
          ],
        },
        {
