      ...
      featureGroups: [
        ...
        },
        {
          ...
          items: [
            ...
            { name: 'Request Log', where: 'More → Request Log', desc: 'Every recorded request, one row each. Filter by client, endpoint, network, verification, user-agent and date to see exactly what a single crawler fetched — the first four take several values at once, so you can watch two crawlers together, or everything spoofed or refused. Every column sorts the whole filtered set, not just the page on screen.', tag: 'On' },
