      ...
      <div class="ar-about-priv__grid">
        <div class="ar-about-priv__cell ar-about-priv__cell--head">
          ...
          <div>
            ...
            <p>
              ...
              read-only key, same direction, numbers in only. <strong>Verify bot identities</strong>:
        ...
        <div class="ar-about-priv__cell">
          ...
          <p>
            ...
            applies. The optional Cloudflare and Bing connections add two more local tables — hourly
            per-crawler counts and daily index numbers, aggregates only, nothing that stands for a person.
          </p>
