      ...
      screens: [
        {
          ...
          title: 'Dashboard',
          where: 'first tab',
          purpose: 'The day’s answer at a glance: your AEO/GEO score with the single most useful next step, the “What Your Site Runs” card — every Agentimus system’s standing in four panels (the doors AI assistants use, the signals you announce, what search shows, and what your writing holds), each led by one number and linking to its full screen — who reached your site (people and machines, counted apart), endpoint activity by day, your busiest AI files, and recent requests. The one-time “Worth a look next” card after setup and the once-per-release “What’s new” card live here too — never anywhere else in wp-admin.',
        ...
        },
        {
          ...
          actions: 'Filter by client, endpoint, network or verdict. Click a user-agent to copy it. Ask “Re-check now” to verify a claimed identity against the operator’s own published checks. Allow, block or ignore a client from the review bell — Manage clients (Settings → AI Access) keeps every standing decision with an undo. Clear the log any time.',
      ...
      featureGroups: [
        ...
        },
        {
          ...
          items: [
            ...
            { name: 'Request Log', where: 'More → Request Log', desc: 'Every recorded request, one row each. Filter by client, endpoint, network, user-agent and date to see exactly what a single crawler fetched.', tag: 'On' },
    ...
    <section id="ar-about-privacy" class="ar-card ar-about-priv">
      ...
      <div class="ar-about-priv__grid">
        ...
        <div class="ar-about-priv__cell">
          ...
          <p>
            An optional, local-only activity log: which endpoint was hit, the client name, a truncated
