            ...
            <div class="ar-modal__scroll">
              ...
              <div v-if="step === 1" class="ar-wiz__step">
                ...
                <p class="ar-modal__lead">
                  Agentomatic helps assistants like ChatGPT and Claude understand and cite your site
              ...
              <div v-else class="ar-wiz__step">
                ...
                <p class="ar-modal__lead">
                  Agentomatic will use this to describe your site to AI assistants. You can fine-tune
