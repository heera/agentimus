      ...
      return (
        {
          ...
          settings: {
            title: 'Settings',
            description: 'Configure the signals Agentomatic exposes and the identity agents read.',
          },
          readiness: {
            title: 'Readiness',
...
<template>
  <div class="ar">
    <header class="ar__bar">
      <button type="button" class="ar__brand" aria-label="Agentomatic — reload" @click="reloadPlugin">
        ...
        <span class="ar__brandtext">
          <span class="ar__name">Agentomatic</span>
