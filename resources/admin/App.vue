...
<template>
  <div class="ar">
    ...
    <main class="ar__body is-railed">
      ...
      <ScoreRail
        :aeo="aeo"
        :site-is-local="siteIsLocal"
        :ring-ready="ringReady"
        :endpoints="endpoints"
        :discovery-docs="discoveryDocs"
        :optimize-total="optimizeTotal"
        :optimize-actionable="optimizeActionable"
        :validation="validation"
        @navigate="goTo"
      />
    </main>

<!-- The rail (score card, endpoint links, registrations) lives in ScoreRail.vue,
         its rung/next-step hover bubble included. -->
  </div>
</template>
