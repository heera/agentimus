...
* **In Google's Index / Found by AI Search** — whether the indexes behind AI Overviews, Gemini, ChatGPT search and Copilot actually hold your pages: the whole site in rotation, every verdict in the engine's own words, problems grouped with deep links to where the fix lives, any page's answer one lookup away — plus week-on-week trend, Google Discover, and the health of the sitemap you registered.
