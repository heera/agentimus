...
= 1.51.5 =
The Cloudflare training notice counts only pages actually served to training crawlers, not robots.txt reads or requests your server refused. No breaking changes.
