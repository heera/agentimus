...
final class Signer {
	...
	const OPTION = 'agentomatic_signing_keys';
	 ...
	 * of the DB — via the `agentomatic_signing_secret_key` filter (base64 of the
	...
	public function keys() {
		...
		$override = (string) apply_filters( 'agentomatic_signing_secret_key', '' );
		if ( '' !== $override ) {
